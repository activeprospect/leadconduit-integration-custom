...
request.variables = () => [
  ...
  { name: 'method', description: 'HTTP method (POST, PUT, DELETE, or PATCH; default: POST)', type: 'string', required: false },
...
module.exports = {
  ...
  validate(vars) {
    return validate.url(vars) ||
           validate.method(vars, ['POST', 'PUT', 'DELETE', 'PATCH']) ||
